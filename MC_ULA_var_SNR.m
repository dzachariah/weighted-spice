...
%RMSE
figure(4)
plot(SNR_list, (180/pi)*sqrt(mean_theta_spice), 'k+-','LineWidth', 1.3), hold on, grid on
plot(SNR_list, (180/pi)*sqrt(mean_theta_likes), 'bo-','LineWidth', 1.3)
plot(SNR_list, (180/pi)*sqrt(mean_theta_slim), 'gd-','LineWidth', 1.3)
plot(SNR_list, (180/pi)*sqrt(mean_theta_iaa), 'rx-','LineWidth', 1.3)
plot(SNR_list, (180/pi)*sqrt(mean_theta_beam), 'k*--','LineWidth', 1.3)
ylabel('RMSE [deg.]')
xlabel('SNR [dB]')
title('DOA')
legend('SPICE','LIKES','SLIM','IAA','Beamformer')
